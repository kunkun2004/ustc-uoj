        ...
        $participants_form = newAddDelCmdForm('participants',
                ...
                function($type, $username) {
                        ...
                        if ($type == '+') {
                                ...
                                DB::query("insert into contests_registrants (username, user_rating, contest_id, has_participated) values ('{$user['username']}', {$user['rating']}, {$contest['id']}, 0)");
...
?>
                ...
                <p class="text-center">命令格式：命令一行一个，+233表示把题号为233的试题加入比赛，-233表示把题号为233的 试题从比赛中移除</p>
